...
subparsers = parser.add_subparsers(dest='proto', help='Higher level protocol to target', required=True)

http_subparser = subparsers.add_parser('http', help='Perform HTTP connection hijacking')
telnet_subparser = subparsers.add_parser('telnet', help='Perform Telnet connection hijacking')
telnet_subparser.add_argument('cmd', help='A command to execute')
